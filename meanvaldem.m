function f = meanvalnodem(theta2)
% This function computes the mean utility level
%  It has been modified to eliminate the demographic variables 
% Written by Aviv Nevo, May 1998.

global theti thetj silent x2 s_jt
load mvalold

% disp([' dim of mvalold at start of meanval sub ' num2str(size(mvalold))])
...
expmu = exp(mufuncdem(x2,theta2w)) ;
norm = 1;
avgnorm = 1;
